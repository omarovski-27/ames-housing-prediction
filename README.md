...
📖 Overview
This project is my solution for the Kaggle House Prices: Advanced Regression Techniques competition. The goal was to predict final house prices in Ames, Iowa, based on 79 explanatory variables describing nearly every aspect of residential homes.
...
ModelRMSELinear Regression$43,038Ridge (α=100)$30,225Random Forest$26,618Gradient Boosting$24,030
Final Model: Gradient Boosting Regressor with default hyperparameters
📈 Results & Iteration
My score progression on Kaggle:
SubmissionScore (RMSLE)What Changed#10.156Initial submission#211.95Broke preprocessing (lesson learned!)#30.130Fixed encoding + removed Id from features
...
Train and test data must undergo identical preprocessing — this caused my biggest bugs
Sanity check predictions before submitting (should be in $50k-$600k range, not negative or millions)
Run notebooks top-to-bottom after changes — out-of-order execution causes subtle bugs
Domain knowledge matters — knowing that NaN in PoolQC means "no pool" beats blind imputation
...
bash   git clone https://github.com/YOUR_USERNAME/ames-housing-prediction.git

Download data from Kaggle
Run the Jupyter notebook:

bash   jupyter notebook House_Prices_Regression.ipynb
🔗 Links
